$(function() {
	...
	// 	} else {
	// 		$("#stateMent").html("楼主异步调用战斗力不感人，目测超过").show();
	// 		callback(new Error(), currentSum, randomSequence, 5, "");
	// 	}
	// }
	$(".apb").click(function() {
		if (!$(this).hasClass("disable")) {
	...
	// 			$(that).addClass("disable").children("span").html(result).show();
	// 			temp.removeClass("disable");
	// 			callback(new Error(), currentSum, randomSequence, 1, "我不知道");
	// 		});
	// 	}
	// }
	// function cHandler(currentSum, randomSequence, callback) {
	...
	// 			$(that).addClass("disable").children("span").html(result).show();
	// 			temp.removeClass("disable");
	// 			callback(new Error(), currentSum, randomSequence, 2, "你不知道");
	// 		});
	// 	}
	// }
	// function dHandler(currentSum, randomSequence, callback) {
	...
	// 			$(that).addClass("disable").children("span").html(result).show();
	// 			temp.removeClass("disable");
	// 			callback(new Error(), currentSum, randomSequence, 3, "他不知道");
	// 		});
	// 	}
	// }
	// function eHandler(currentSum, randomSequence, callback) {
	...
	// 			$(that).addClass("disable").children("span").html(result).show();
	// 			temp.removeClass("disable");
	// 			callback(new Error(), currentSum, randomSequence, 4, "才怪");
	// 		});
	// 	}
	// }
	// function bubbleHandler(currentSum, randomSequence, callback) {
